...
import colorFormat from './plugins/customFormat'
import customKeyword from './plugins/customKeywords'
...
export default defineComponent({
  setup() {
    ...
    const demo: {
      ...
      dataCode: string
      uiSchemaCode: string
      customValidate: ((data: any, err: any) => void) | undefined
    } = reactive({
      schema: null,
      data: {},
      uiSchema: {},
